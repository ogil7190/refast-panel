...
export const GET_PAYMENTS_URL = `${HOST}/panel/allPayments`
export const SEARCH_PAYMENT_URL = `${HOST}/panel/getPayment`
export const SEARCH_USER_URL = `${HOST}/panel/getUser`
export const SEARCH_ORDER_URL = `${HOST}/panel/getOrder`
